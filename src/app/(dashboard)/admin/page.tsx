...
const adminSections = [
  {
    ...
    description: "Manage compute resources and HPC clusters",
    href: "/admin/compute-resources",
    icon: Server,
    color: "text-blue-600",
    bgColor: "bg-blue-100",
  },
  {
    ...
    description: "Manage storage resources and file systems",
    href: "/admin/storage-resources",
    icon: Database,
