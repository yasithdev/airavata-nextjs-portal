...
interface ApplicationSearchSelectProps {
  ...
  selectedApplication?: ApplicationInterfaceDescription;
  onSelect: (application: ApplicationInterfaceDescription) => void;
  isLoading?: boolean;
  placeholder?: string;
}
...
export function ApplicationSearchSelect({
  ...
  const handleSelect = (app: ApplicationInterfaceDescription) => {
    onSelect(app);
    setIsOpen(false);
    setSearchTerm("");
  };
    ...
    <div className="relative w-full" ref={dropdownRef}>
      ...
      >
        <span className="truncate">
          {selectedApplication ? selectedApplication.applicationName : placeholder}
        </span>
              ...
              filteredApplications.map((app) => (
                <button
                  ...
                  className={cn(
                    ...
                    selectedApplication?.applicationInterfaceId === app.applicationInterfaceId &&
                      "bg-accent"
                  )}
